...
namespace tri {
    ...
    double tan_deg (int _deg, double adj) {
        return (tan((_deg * PI) / 180) * adj);
    }

    double sin_deg (int _deg, double hyp) {
        return (sin((_deg * PI) / 180) * hyp);
    }

    double cos_deg (int _deg, double hyp) {
        return (cos((_deg * PI) / 180) * hyp);
    }
